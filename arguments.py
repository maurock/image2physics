# File edited from
# https://github.com/ajzhai/NeRF2Physics/blob/master/arguments.py, MIT License
import argparse
...
def get_args():
    ...
    parser.add_argument('--dataparser', type=str, default='nerfstudio-data',
                        help='dataparser to use (default: nerfstudio-data)')
    ...
    # NeRF segmentation and mesh extraction
    parser.add_argument('--text_prompt', type=str, default='', help='Text input for mesh extraction. It must be a sequence of words separated by a full stop and a space. (default: "")')
